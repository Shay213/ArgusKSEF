...
import FaWierszTotal from './FaWierszTotal'
...
const FaWierszFakturaPodstawowa = ({ optional }: Props): JSX.Element => {
  const { control, setValue } = useFormContext()

  const setTotal = ({ KwotaBrutto, KwotaNetto, KwotaPodatku }: Total): void => {
    setValue('P_13_1', KwotaNetto)
    setValue('P_14_1', KwotaPodatku)
    setValue('P_15', KwotaBrutto)
  }
  ...
  return (
    ...
    >
      ...
      />
      <FaWierszTotal control={control} setTotal={setTotal} />
    </FormSection>
  )
}

export default FaWierszFakturaPodstawowa
