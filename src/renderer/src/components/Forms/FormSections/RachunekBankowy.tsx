...
const RachunekBankowy = ({ formFieldNamePrefix, optional }: Props): JSX.Element => {
  return (
    <FormSection
      title="RachunekBankowy"
      size="default"
      optional={optional}
      tooltipMessage="Element zawierający dane rachunku, na który
    ...
    >
      <TableFormItem
        fieldName={`${formFieldNamePrefix ?? ''}RachunekBankowy`}
        addButtonLabel="Dodaj RachunekBankowy"
...
export default RachunekBankowy
